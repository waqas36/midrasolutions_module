...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    _ismidrarsolutionsFocused: true,
     ...
     * @returns {boolean}
     */
    ismidrarsolutionsFocused: function () {
        return this._ismidrarsolutionsFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._ismidrarsolutionsFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._ismidrarsolutionsFocused);
        }
    },
    /**
