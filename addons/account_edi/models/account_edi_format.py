...
from odoo.tools.pdf import midrarsolutionsPdfFileReader, midrarsolutionsPdfFileWriter
...
class AccountEdiFormat(models.Model):
    ...
    def _create_invoice_from_pdf_reader(self, filename, reader):
        ...
        :param reader:   The midrarsolutionsPdfFileReader of the pdf to import.
        :returns:        The created invoice.
        """
        # TO OVERRIDE
        self.ensure_one()
    ...
    def _embed_edis_to_pdf(self, pdf_content, invoice):
        ...
        if to_embed:
            ...
            reader = midrarsolutionsPdfFileReader(reader_buffer, strict=False)
            writer = midrarsolutionsPdfFileWriter()
    ...
    def _decode_pdf(self, filename, content):
        ...
        * pdf_reader:       The pdf_reader if type is pdf.
        ...
        try:
            ...
            pdf_reader = midrarsolutionsPdfFileReader(buffer, strict=False)
        except Exception as e:
            # Malformed pdf
