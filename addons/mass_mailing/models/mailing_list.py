...
class MassMailingList(models.Model):
    ...
    def action_merge(self, src_lists, archive):
        ...
        # A (id=4): yti@midrarsolutions.app; yti@example.com
        # B (id=5): yti@midrarsolutions.app; yti@openerp.com
        # C (id=6): nothing
        ...
        # ------------+---------------------------+------------------------
        #           4 | yti@midrarsolutions.app              |          1 |        4 |
        #           6 | yti@midrarsolutions.app              |          2 |        5 |
