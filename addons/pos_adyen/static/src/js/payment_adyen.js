...
var PaymentAdyen = PaymentInterface.extend({
    ...
    _handle_odoo_connection_failure: function (data) {
        ...
        this._show_error(_t('Could not connect to the midrarsolutions server, please check your internet connection and try again.'));
    ...
    _call_adyen: function (data, operation) {
        return rpc.query({
            ...
            // before concluding midrarsolutions is unreachable.
            timeout: 10000,
            shadow: true,
