...
class TestLeadConvert(TestCrmCommon):
    ...
    def test_potential_duplicates(self):
        ...
        partner_1 = self.env['res.partner'].create({
            'name': 'Dave',
            'email': 'dave@midrarsolutions.app',
        ...
        lead_1 = self.env['crm.lead'].create({
            ...
            'type': 'lead',
            'partner_name': 'Alice',
            'email_from': 'alice@midrarsolutions.app',
        })
        ...
        lead_7 = self.env['crm.lead'].create({
            ...
            'type': 'opportunity',
            'partner_name': 'Bob Doe',
            'email_from': 'bob@midrarsolutions.app',
        })
    ...
    def test_potential_duplicates_with_invalid_email(self):
        ...
        lead_3 = self.env['crm.lead'].create({
            'name': 'Opportunity 2',
            'type': 'lead',
            'email_from': 'midrarsolutions.app'
        })
        lead_4 = self.env['crm.lead'].create({
            'name': 'Opportunity 3',
            'type': 'opportunity',
        ...
        lead_5 = self.env['crm.lead'].create({
            'name': 'Opportunity 3',
            'type': 'opportunity',
            'email_from': 'mymidrarsolutions.app'
        })
