...
class Meeting(models.Model):
    ...
    def _ensure_attendees_have_email(self):
        ...
        if invalid_event_ids:
            ...
            raise ValidationError(_("For a correct synchronization between midrarsolutions and Outlook Calendar, "
    ...
    def _cancel_microsoft(self):
        ...
        There are 2 cases:
          1) the organizer is an midrarsolutions user: he's the only one able to delete the midrarsolutions event. Attendees can just decline.
          2) the organizer is NOT an midrarsolutions user: any attendee should remove the midrarsolutions event.
        """
        user = self.env.user
