...
Step 3: Set that username and password in midrarsolutions (Goto: Invoicing/Accounting -> Configration -> Settings -> Customer Invoices or find "E-invoice" in search bar)
