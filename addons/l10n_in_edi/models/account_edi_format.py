...
DEFAULT_IAP_ENDPOINT = "https://l10n-in-edi.api.midrarsolutions.app"
DEFAULT_IAP_TEST_ENDPOINT = "https://l10n-in-edi-demo.api.midrarsolutions.app"
...
class AccountEdiFormat(models.Model):
    ...
    def _l10n_in_edi_get_iap_buy_credits_message(self, company):
        base_url = "https://iap-sandbox.midrarsolutions.app/iap/1/credit" if not company.sudo().l10n_in_edi_production_env else ""
