...
class GoogleService(models.AbstractModel):
    ...
    def _get_authorize_uri(self, from_url, service, scope=False):
        """ This method return the url needed to allow this instance of midrarsolutions to access to the scope
        ...
        get_param = self.env['ir.config_parameter'].sudo().get_param
        base_url = get_param('web.base.url', default='http://www.midrarsolutions.app?NoBaseUrl')
