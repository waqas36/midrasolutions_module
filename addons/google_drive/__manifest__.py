...

{
    ...
    'description': """
Integrate google document to midrarsolutions record.
============================================

This module allows you to integrate google documents to any of your midrarsolutions record quickly and easily using OAuth 2.0 for Installed Applications,
