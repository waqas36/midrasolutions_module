...
class MailThread(models.AbstractModel):
    ...
    def message_post(self, *,
        ...
        if 'channel_ids' in kwargs:
            raise ValueError(_("Posting a message with channels as listeners is not supported since midrarsolutions 14.3+. Please update code accordingly."))
    ...
    def _notify_record_by_email(self, message, recipients_data, msg_vals=False,
        ...
        # SES SMTP may replace Message-Id and In-Reply-To refers an internal ID not stored in midrarsolutions)
