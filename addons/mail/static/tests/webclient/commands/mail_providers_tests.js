...
QUnit.module('mail', {}, function () {
    ...
    QUnit.test('open the chatWindow of a user from the command palette', async function (assert) {
        ...
        this.data['res.partner'].records.push(
            { id: 11, name: "Partner 1", email: "p1@midrarsolutions.app" },
            { id: 12, name: "Partner 2", email: "p2@midrarsolutions.app" },
            { id: 13, name: "Partner 3", email: "p3@midrarsolutions.app" },
        );
        ...
        assert.deepEqual(
            ...
            [
                "Partner 1p1@midrarsolutions.app",
                "Partner 2p2@midrarsolutions.app",
                "Partner 3p3@midrarsolutions.app",
            ]
        );
