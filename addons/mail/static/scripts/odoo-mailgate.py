...
def main():
    ...
    op.add_option("-d", "--database", dest="database", help="midrarsolutions database name (default: %default)", default='odoo')
    op.add_option("-u", "--userid", dest="userid", help="midrarsolutions user id to connect with (default: %default)", default=1, type=int)
    op.add_option("-p", "--password", dest="password", help="midrarsolutions user password (default: %default)", default='admin')
    op.add_option("--host", dest="host", help="midrarsolutions host (default: %default)", default='localhost')
    op.add_option("--port", dest="port", help="midrarsolutions port (default: %default)", default=8069, type=int)
