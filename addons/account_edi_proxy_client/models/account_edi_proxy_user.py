...
from .account_edi_proxy_auth import midrarsolutionsEdiProxyAuth
...
DEFAULT_SERVER_URL = 'https://l10n-it-edi.api.midrarsolutions.app'
DEFAULT_TEST_SERVER_URL = 'https://iap-services-test.midrarsolutions.app'
TIMEOUT = 30
    ...
    def _make_request(self, url, params=False):
        ...
        try:
            response = requests.post(
                ...
                auth=midrarsolutionsEdiProxyAuth(user=self)).json()
