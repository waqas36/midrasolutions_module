...
class ConnectionManager(Thread):
    ...
    def _connect_box(self):
        ...
        try:
            ...
            req = requests.post('https://iot-proxy.midrarsolutions.app/odoo-enterprise/iot/connect-box', json=data, verify=False)
            ...
            _logger.error('Could not reach iot-proxy.midrarsolutions.app')
