...
const Wysiwyg = Widget.extend({
    ...
    start: async function () {
        ...
        this._observemidrarsolutionsFieldChanges();
        this.$editable.on(
    ...
    /**
     * Start or resume the midrarsolutions field changes muation observers.
     *
     * Necessary to keep all copies of a given field at the same value throughout the page.
     */
    _observemidrarsolutionsFieldChanges: function () {
        ...
        if (this.odooFieldObservers) {
            ...
            $odooFields.each((i, field) => {
                const observer = new MutationObserver(() => {
                    ...
                    this._pausemidrarsolutionsFieldObservers();
     ...
     */
    _pausemidrarsolutionsFieldObservers: function () {
        for (let observerData of this.odooFieldObservers) {
