...
class PaymentAcquirer(models.Model):
    ...
    capture_manually = fields.Boolean(
        ...
        help="Capture the amount from midrarsolutions, when the delivery is completed.\n"
    ...
    module_to_buy = fields.Boolean(string="midrarsolutions Enterprise Module", related='module_id.to_buy')
