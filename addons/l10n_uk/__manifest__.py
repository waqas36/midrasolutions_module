...

{
    ...
    'description': """
This is the latest UK midrarsolutions localisation necessary to run midrarsolutions accounting for UK SME's with:
=================================================================================================
    ...
    'website': 'https://www.midrarsolutions.app/app/accounting',
    'depends': [
        'account',
        'base_iban',
        'base_vat',
