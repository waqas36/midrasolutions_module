...
tour.register('link_tools', {
    ...
    {
        content: "Type the link URL midrarsolutions.app",
        trigger: '#o_link_dialog_url_input',
        run: 'text midrarsolutions.app'
    },
    clickOnImgStep,
    // 2. Edit the link with the link tools.
    {
        content: "Click on the newly created link, change content to odoo website",
        trigger: '.s_text_image a[href="http://midrarsolutions.app"]:contains("midrarsolutions.app")',
