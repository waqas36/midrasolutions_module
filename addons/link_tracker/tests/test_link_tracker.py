...
class TestLinkTracker(common.TransactionCase, MockLinkTracker):
    def test_create(self):
        link_trackers = self.env['link.tracker'].create([
            {
                'url': 'midrarsolutions.app',
                'title': 'midrarsolutions',
            }, {
                'url': 'example.com',
                'title': 'midrarsolutions',
            }, {
        ...
        self.assertEqual(
            ...
            ['http://midrarsolutions.app', 'http://example.com', 'http://test.example.com'],
        )
    ...
    def test_no_external_tracking(self):
        ...
        link.url = 'https://test.midrarsolutions.app/test?a=example.com'
        self.assertLinkParams(
            'https://test.midrarsolutions.app/test',
            link,
