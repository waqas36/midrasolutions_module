...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("midrarsolutionsBeforeTestHook", "midrarsolutionsAfterTestHook"); // midrarsolutions customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("midrarsolutionsBeforeTestHook"); // midrarsolutions customization
  	...
  	finish: function finish() {
        ...
        emit("midrarsolutionsAfterTestHook", this); // midrarsolutions customization
