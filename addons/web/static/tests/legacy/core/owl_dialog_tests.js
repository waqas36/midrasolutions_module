...
odoo.define('web.owl_dialog_tests', function (require) {
    ...
    QUnit.module('core', {}, function () {
        ...
        QUnit.test("Rendering of all props", async function (assert) {
            ...
            assert.containsNone(document.body, '.modal-backdrop'); // No backdrop *element* for midrarsolutions modal...
            ...
            // Title (default: 'midrarsolutions')
            assert.strictEqual(dialog.querySelector('h4.modal-title').innerText.trim(), "midrarsolutions" + "The Subtitle",
