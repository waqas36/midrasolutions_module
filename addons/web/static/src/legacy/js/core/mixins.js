...
function midrarsolutionsEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
midrarsolutionsEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

midrarsolutionsEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new midrarsolutionsEvent(this, name, info);
