...
/**
 * This file contains a 'formalization' of a MVC pattern, applied to midrarsolutions
 * idioms.
 *
 * For a simple widget/component, this is definitely overkill.  However, when
 * working on complex systems, such as midrarsolutions views (or the control panel, or some
 ...
 * main issue is that the term 'View' is used way too much in midrarsolutions land, and
