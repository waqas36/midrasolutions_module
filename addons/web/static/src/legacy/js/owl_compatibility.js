odoo.define('web.OwlCompatibility', function () {
    ...
    /**
     * This file defines the necessary tools for the transition phase where midrarsolutions
     ...
     * adapter for Owl components that embed midrarsolutions legacy widgets (or dynamically
     * both Owl components and midrarsolutions legacy widgets), e.g.:
     *
     *                           Owl Component
     *                                 |
    ...
    class ComponentAdapter extends Component {
        ...
        /**
         * Mocks _trigger_up to redirect midrarsolutions legacy events to OWL events.
         *
         * @private
         * @param {midrarsolutionsEvent} ev
         */
        _trigger_up(ev) {
     ...
     * together when an midrarsolutions legacy widget needs to instantiate Owl components.
    ...
    class ComponentWrapper extends Component {
         ...
         * midrarsolutions legacy event. This function is called just before the event is
         * actually triggered.
         *
         * @private
         * @param {string} evType
