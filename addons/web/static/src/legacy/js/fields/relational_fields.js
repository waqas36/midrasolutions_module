...
var FieldMany2One = AbstractField.extend({
    ...
    */
     ...
     *
     * @param {midrarsolutionsEvent} event 'field_changed' event
     */
    ...
    /**
     * @private
     * @param {midrarsolutionsEvent} event
     */
...
var FieldX2Many = AbstractField.extend(WidgetAdapterMixin, {
     ...
     * @override
     * @param {Object} record
     * @param {midrarsolutionsEvent} [ev] an event that triggered the reset action
...
var FieldOne2Many = FieldX2Many.extend({
     ...
     * @override
     * @private
     * @param {midrarsolutionsEvent|MouseEvent} ev this event comes either from the 'Add
