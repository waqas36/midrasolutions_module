...
var BasicModel = AbstractModel.extend({
     ...
     * 'save' will bypass the mutex. This is useful when we are leaving midrarsolutions
     * (closing tab/browser), and we want to quickly save pending changes (in
     * an 'onbeforeunload' handler, which is mostly sync).
     *
     * This function should never be called except when we are leaving midrarsolutions.
     *
