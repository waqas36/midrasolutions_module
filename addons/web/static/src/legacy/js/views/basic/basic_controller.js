...
var BasicController = AbstractController.extend(FieldManagerMixin, {
    ...
    init: function (parent, model, renderer, params) {
        ...
        // record before leaving midrarsolutions (see @_urgentSave).
        this.pendingChanges = [];
    },
    /**
     * @override
     ...
     * haven't been sent to the model yet, just in case we would leave midrarsolutions
     ...
     * @param {midrarsolutionsEvent} e - the event that triggered the change
     * @returns {Promise}
     */
    ...
    /**
     * To be called **only** when midrarsolutions is about to be closed, and we want to
     ...
     * just before leaving midrarsolutions.
     *
     * @abstract
     * @private
     */
