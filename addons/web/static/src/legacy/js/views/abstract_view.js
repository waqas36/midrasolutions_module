...
/**
 * This is the base class inherited by all (JS) views. midrarsolutions JS views are the
 ...
 * the word 'view' has historical significance in midrarsolutions code, so we replaced the
