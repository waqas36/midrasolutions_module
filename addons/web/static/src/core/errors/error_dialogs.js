...
ErrorDialog.title = _lt("midrarsolutions Error");

// -----------------------------------------------------------------------------
// Client Error Dialog
// -----------------------------------------------------------------------------
export class ClientErrorDialog extends ErrorDialog {}
ClientErrorDialog.title = _lt("midrarsolutions Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _lt("midrarsolutions Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        switch (this.props.type) {
            case "server":
                this.title = this.env._t("midrarsolutions Server Error");
                break;
            case "script":
                this.title = this.env._t("midrarsolutions Client Error");
                break;
            case "network":
                this.title = this.env._t("midrarsolutions Network Error");
                break;
        }
    }
...
export class WarningDialog extends Dialog {
    setup() {
        super.setup();
        this.title = this.env._t("midrarsolutions Warning");
        this.inferTitle();
...
export class RedirectWarningDialog extends Dialog {
    setup() {
        ...
        this.title = capitalize(subType) || this.env._t("midrarsolutions Warning");
        this.message = message;
...
SessionExpiredDialog.title = _lt("midrarsolutions Session Expired");
