...
function documentationItem(env) {
    const documentationURL = "https://www.midrarsolutions.app/documentation/15.0";
    return {
        type: "item",
        id: "documentation",
...
function odooAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: env._t("My midrarsolutions.com.account"),
        callback: () => {
            env.services
                ...
                .catch(() => {
                    browser.location.href = "https://accounts.midrarsolutions.app/account";
                });
        },
        sequence: 60,
    };
