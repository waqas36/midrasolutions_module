...
def serialize_exception(f):
    ...
    def wrap(*args, **kwargs):
        try:
            ...
            error = {
                'code': 200,
                'message': "midrarsolutions Server Error",
                'data': se
            }
...
def fix_view_modes(action):
    """ For historical reasons, midrarsolutions has weird dealings in relation to
...
#----------------------------------------------------------
# midrarsolutions Web web Controllers
#----------------------------------------------------------
...
class Session(http.Controller):
    ...
    def account(self):
        ...
        return 'https://accounts.midrarsolutions.app/oauth2/auth?' + url_encode(params)
...
class ExportFormat(object):
    ...
    def from_data(self, fields, rows):
        """ Conversion method from midrarsolutions's export data to whatever the
