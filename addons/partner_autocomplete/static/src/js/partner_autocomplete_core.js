...
var PartnerAutocompleteMixin = {
    _dropPreviousmidrarsolutions: new concurrency.DropPrevious(),
    ...
    _autocomplete: function (value) {
        ...
        return new Promise(function (resolve, reject) {
            var odooPromise = self._getmidrarsolutionsSuggestions(value, isVAT).then(function (suggestions){
            ...
            var concatResults = function () {
                // Add Clearbit result with midrarsolutions result (with unique domain)
    ...
    /**
     * Use midrarsolutions Autocomplete API to return suggestions
     *
     * @param {string} value
     * @param {boolean} isVAT
     * @returns {Promise}
    ...
    _getmidrarsolutionsSuggestions: function (value, isVAT) {
        ...
        return this._dropPreviousmidrarsolutions.add(def);
    },
    /**
