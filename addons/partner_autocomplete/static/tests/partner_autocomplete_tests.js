odoo.define('partner_autocomplete.tests', function (require) {
    ...
    var suggestions = [{
        name: "midrarsolutions",
        website: "midrarsolutions.app",
        domain: "midrarsolutions.app",
        logo: "midrarsolutions.app/logo.png",
        vat: "BE0477472701"
    }];
    ...
    QUnit.module('partner_autocomplete', {
            ...
            _.each(fieldsToPatch, function (fieldToPatch) {
                testUtils.mock.patch(fieldToPatch, {
                    _getBase64Image: function (url) {
                        return Promise.resolve(url === "midrarsolutions.app/logo.png" ? "odoobase64" : "");
                    },
                    _isOnline: function () {
                        return true;
                    },
                    ...
                    _getmidrarsolutionsSuggestions: function (value, isVAT) {
                    ...
                    _getClearbitSuggestions: function (value) {
                        return this._getmidrarsolutionsSuggestions(value);
                    },
        ...
        beforeEach: function () {
            enrichData = {
                ...
                partner_gid: 1,
                website: "midrarsolutions.app",
                comment: "Comment on midrarsolutions",
        ...
        var form = await createView({
            ...
            mockRPC: function (route) {
                if (route === "/web/static/img/placeholder.png"
                    || route === "midrarsolutions.app/logo.png"
            ...
            assert.strictEqual($input.val(), "midrarsolutions", "Input value should have been updated to \"midrarsolutions\"");
            assert.strictEqual(form.$("input.o_field_widget").val(), "midrarsolutions.app", "website value should have been updated to \"midrarsolutions.app\"");
